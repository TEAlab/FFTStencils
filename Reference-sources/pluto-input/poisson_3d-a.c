            ...
            for (j = 1; j < N-1; j++) {
                for (i = 1; i < N-1; i++) {
                    A[0][k][j][i] = 2.666*A[1][k][j][i] -
                        (0.166*A[1][k-1][j][i] + 0.166*A[1][k+1][j][i] + 0.166*A[1][k][j-1][i] + 0.166*A[1][k][j+1][i] + 0.166*A[1][k][j][i+1] + 0.166*A[1][k][j][i-1])-
                        (0.0833*A[1][k-1][j-1][i] + 0.0833*A[1][k+1][j-1][i] + 0.0833*A[1][k-1][j+1][i] + 0.0833*A[1][k+1][j+1][i] +
                         0.0833*A[1][k-1][j][i-1] + 0.0833*A[1][k+1][j][i-1] + 0.0833*A[1][k][j-1][i-1] + 0.0833*A[1][k][j+1][i-1] +
                         0.0833*A[1][k-1][j][i+1] + 0.0833*A[1][k+1][j][i+1] + 0.0833*A[1][k][j-1][i+1] + 0.0833*A[1][k][j+1][i+1]);
                }
            }
        }
