 ...
 * For compiling --> 
        ...
        icc -std=gnu++98 -O3 -qopenmp -xhost -ansi-alias -ipo -qopt-prefetch=9 -AVX512 mkl_3d_poisson_fftw_NP-n-polylog-gen.cpp -o mkl_3d_poisson_fftw_NP-n-polylog-gen -lm -mkl

 * For running -->
 * ./mkl_3d_poisson_fftw_NP-n-polylog-gen 8000 8000 8000 64 32768 68 0
...
void create_poisson_stencil( double *stencil_real, int N1, int N2, int N3 )
{
    int N2N3 = N2 * N3;
    int N1N2N3 = N1 * N2N3;
    ...
    stencil_real[ 0 ] = 2.9956;
    stencil_real[ 1 ] = - 0.166;    
    stencil_real[ N3 - 1 ] = - 0.166;    
    stencil_real[ N3 ] = - 0.166;    
    stencil_real[ N3 + 1 ] = - 0.0833;    
    stencil_real[ 2 * N3 - 1 ] = - 0.0833;    
    stencil_real[ N2N3 - N3 ] = - 0.166;    
    stencil_real[ N2N3 - N3 + 1 ] = - 0.0833;    
    stencil_real[ N2N3 - 1 ] = - 0.0833;    

    stencil_real[ N2N3 ] = - 0.166;
    stencil_real[ N2N3 + 1 ] = - 0.0833;    
    stencil_real[ N2N3 + N3 - 1 ] = - 0.0833;    
    stencil_real[ N2N3 + N3 ] = - 0.0833;    
//    stencil_real[ N2N3 + N3 + 1 ] = - 0.0833;    
//    stencil_real[ N2N3 + 2 * N3 - 1 ] = - 0.0833;    
    stencil_real[ 2 * N2N3 - N3 ] = - 0.0833;    
//    stencil_real[ 2 * N2N3 - N3 + 1 ] = - 0.0833;    
//    stencil_real[ 2 * N2N3 - 1 ] = - 0.0833;    

    stencil_real[ N1N2N3 - N2N3 ] = - 0.166;
    stencil_real[ N1N2N3 - N2N3 + 1 ] = - 0.0833;    
    stencil_real[ N1N2N3 - N2N3 + N3 - 1 ] = - 0.0833;    
    stencil_real[ N1N2N3 - N2N3 + N3 ] = - 0.0833;    
//    stencil_real[ N1N2N3 - N2N3 + N3 + 1 ] = - 0.0833;    
//    stencil_real[ N1N2N3 - N2N3 + 2 * N3 - 1 ] = - 0.0833;    
    stencil_real[ N1N2N3 - N3 ] = - 0.0833;    
//    stencil_real[ N1N2N3 - N3 + 1 ] = - 0.0833;    
//    stencil_real[ N1N2N3 - 1 ] = - 0.0833;    
}
...
int find_stencil_index( int N1, int N2, int N3, int T )
{
    ...
    if ( got == stencil_map.end( ) )
      {            
        ...
        if  ( got == stencil_map.end( ) )
           {        
	         create_poisson_stencil( stencil_real, N1, N2, N3 );
	        ...
	        for ( int i = 1; i < N1 - 1; i++ ) 
	          {
    	        ...
    	        for ( int j = 1; j < N2 - 1; j++ ) 
    	          {
    		        ...
    		        for ( int k = 1; k < N3 - 1; k++ ) 
	                    tmp____real[ k ] = 2.9956 * output____real[ k ]
	                                    - 0.166 * ( output____real[ k - N2N3 ] + output____real[ k + N2N3 ]
	                                              + output____real[ k - N3 ] + output____real[ k + N3 ]
   	                                              + output____real[ k - 1 ] + output____real[ k + 1 ] ) 
   	                                    - 0.0833 * ( output____real[ k - N2N3 - N3 ] 
   	                                               + output____real[ k - N2N3 - 1 ] + output____real[ k - N2N3 + 1 ] 
   	                                               + output____real[ k - N2N3 + N3 ]
   	                                               + output____real[ k - N3 - 1 ] + output____real[ k - N3 + 1 ] 
   	                                               + output____real[ k + N3 - 1 ] + output____real[ k + N3 + 1 ] 
   	                                               + output____real[ k + N2N3 - N3 ] 
   	                                               + output____real[ k + N2N3 - 1 ] + output____real[ k + N2N3 + 1 ] 
   	                                               + output____real[ k + N2N3 + N3 ] );
                    ...
                    tmp____real[ k ] = 2.9956 * output____real[ k ]
                                    - 0.166 * ( output____real[ k - N2N3 ] + output____real[ k + N2N3 ]
                                              ...
                                              + output____real[ k + 1 ] ) 
                                    - 0.0833 * ( output____real[ k - N2N3 - N3 ] 
                                               + output____real[ k - N2N3 + 1 ] 
                                               + output____real[ k - N2N3 + N3 ]
                                               + output____real[ k - N3 + 1 ] 
                                               + output____real[ k + N3 + 1 ] 
                                               + output____real[ k + N2N3 - N3 ] 
                                               + output____real[ k + N2N3 + 1 ] 
                                               + output____real[ k + N2N3 + N3 ] );
		        ...
		        for ( int k = 1; k < N3 - 1; k++ ) 
                    tmp____real[ k ] = 2.9956 * output____real[ k ]
                                    - 0.166 * ( output____real[ k - N2N3 ] + output____real[ k + N2N3 ]
                                              + output____real[ k + N3 ]
                                              + output____real[ k - 1 ] + output____real[ k + 1 ] ) 
                                    - 0.0833 * ( output____real[ k - N2N3 - 1 ] + output____real[ k - N2N3 + 1 ] 
                                               + output____real[ k - N2N3 + N3 ]
                                               + output____real[ k + N3 - 1 ] + output____real[ k + N3 + 1 ] 
                                               + output____real[ k + N2N3 - 1 ] + output____real[ k + N2N3 + 1 ] 
                                               + output____real[ k + N2N3 + N3 ] );
                ...
                tmp____real[ k ] = 2.9956 * output____real[ k ]
                                - 0.166 * ( output____real[ k - N2N3 ] + output____real[ k + N2N3 ]
                                          + output____real[ k + N3 ]
                                          + output____real[ k + 1 ] ) 
                                - 0.0833 * ( output____real[ k - N2N3 + 1 ] 
                                           + output____real[ k - N2N3 + N3 ]
                                           + output____real[ k + N3 + 1 ] 
                                           + output____real[ k + N2N3 + 1 ] 
                                           + output____real[ k + N2N3 + N3 ] );
	        ...
	        for ( int j = 1; j < N2 - 1; j++ ) 
	          {
		        ...
		        for ( int k = 1; k < N3 - 1; k++ ) 
	                tmp____real[ k ] = 2.9956 * output____real[ k ]
	                                - 0.166 * ( output____real[ k + N2N3 ]
	                                          + output____real[ k - N3 ] + output____real[ k + N3 ]
	                                          + output____real[ k - 1 ] + output____real[ k + 1 ] ) 
	                                - 0.0833 * ( output____real[ k - N3 - 1 ] + output____real[ k - N3 + 1 ] 
	                                           + output____real[ k + N3 - 1 ] + output____real[ k + N3 + 1 ] 
	                                           + output____real[ k + N2N3 - N3 ] 
	                                           + output____real[ k + N2N3 - 1 ] + output____real[ k + N2N3 + 1 ] 
	                                           + output____real[ k + N2N3 + N3 ] );
    	        ...
    	        for ( int j = 1; j < N2 - 1; j++ ) 
    	          {
					...
					#pragma vector always	            
    		        for ( int k = 1; k < N3 - 1; k++ ) 
	                    output____real[ k ] = 2.9956 * tmp____real[ k ]
		                                    - 0.166 * ( tmp____real[ k - N2N3 ] + tmp____real[ k + N2N3 ]
		                                              + tmp____real[ k - N3 ] + tmp____real[ k + N3 ]
	   	                                              + tmp____real[ k - 1 ] + tmp____real[ k + 1 ] ) 
	   	                                    - 0.0833 * ( tmp____real[ k - N2N3 - N3 ] 
	   	                                               + tmp____real[ k - N2N3 - 1 ] + tmp____real[ k - N2N3 + 1 ] 
	   	                                               + tmp____real[ k - N2N3 + N3 ]
	   	                                               + tmp____real[ k - N3 - 1 ] + tmp____real[ k - N3 + 1 ] 
	   	                                               + tmp____real[ k + N3 - 1 ] + tmp____real[ k + N3 + 1 ] 
	   	                                               + tmp____real[ k + N2N3 - N3 ] 
	   	                                               + tmp____real[ k + N2N3 - 1 ] + tmp____real[ k + N2N3 + 1 ] 
	   	                                               + tmp____real[ k + N2N3 + N3 ] );
		        ...
		        for ( int k = 1; k < N3 - 1; k++ ) 
                    output____real[ k ] = 2.9956 * tmp____real[ k ]
	                                    - 0.166 * ( tmp____real[ k - N2N3 ] + tmp____real[ k + N2N3 ]
	                                              + tmp____real[ k + N3 ]
	                                              + tmp____real[ k - 1 ] + tmp____real[ k + 1 ] ) 
	                                    - 0.0833 * ( tmp____real[ k - N2N3 - 1 ] + tmp____real[ k - N2N3 + 1 ] 
	                                               + tmp____real[ k - N2N3 + N3 ]
	                                               + tmp____real[ k + N3 - 1 ] + tmp____real[ k + N3 + 1 ] 
	                                               + tmp____real[ k + N2N3 - 1 ] + tmp____real[ k + N2N3 + 1 ] 
	                                               + tmp____real[ k + N2N3 + N3 ] );
	        ...
	        for ( int j = 1; j < N2 - 1; j++ ) 
	          {
		        ...
		        for ( int k = 1; k < N3 - 1; k++ ) 
	                output____real[ k ] = 2.9956 * tmp____real[ k ]
		                                - 0.166 * ( tmp____real[ k + N2N3 ]
		                                          + tmp____real[ k - N3 ] + tmp____real[ k + N3 ]
		                                          + tmp____real[ k - 1 ] + tmp____real[ k + 1 ] ) 
		                                - 0.0833 * ( tmp____real[ k - N3 - 1 ] + tmp____real[ k - N3 + 1 ] 
		                                           + tmp____real[ k + N3 - 1 ] + tmp____real[ k + N3 + 1 ] 
		                                           + tmp____real[ k + N2N3 - N3 ] 
		                                           + tmp____real[ k + N2N3 - 1 ] + tmp____real[ k + N2N3 + 1 ] 
		                                           + tmp____real[ k + N2N3 + N3 ] );
...
void compute_aperiodic_poisson_stencil( double *input__real, double *output__real, double *tmp__real, int N1, int N2, int N3, int T )
{
...
//        omp_set_nested( 1 );        
    ...
    compute_aperiodic_poisson_stencil( input_real, output_real, tmp_real, N1_orig, N2_orig, N3_orig, T_orig );
